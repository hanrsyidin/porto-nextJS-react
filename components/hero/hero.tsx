...
const HeroSection = () => {
  return (
    <section className="overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-10 lg:py-8 bg-zinc-200/50 rounded-4xl">
        <div className="grid lg:grid-cols-12 lg:gap-x-8 xl:gap-x-12 items-center">
          <div className="lg:col-span-7 xl:col-span-6 text-center lg:text-left">
            <div className="inline-flex items-center bg-white border border-gray-200 rounded-full py-1 pl-4 pr-1.5 text-xs sm:text-sm mb-8 shadow-sm">
              ...
              <Link
                href="#"
                className="inline-flex items-center px-3 py-1 bg-zinc-800 text-white text-xs font-semibold rounded-full hover:bg-gray-700 transition-colors"
              >
                Join now
            ...
            <div className="mt-10 flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-4">
              <Link
                href="#"
                className="inline-flex items-center justify-center px-6 py-3 sm:px-7 sm:py-3.5 border border-gray-300 text-base font-medium rounded-lg shadow-sm text-gray-800 bg-white hover:bg-zinc-50 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400"
              >
                About Me
              ...
              <Link
                href="#"
                className="inline-flex items-center justify-center px-6 py-3 sm:px-7 sm:py-3.5 border border-transparent text-base font-medium rounded-lg shadow-sm text-white bg-zinc-800 hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-600"
              >
                Contact
              </Link>
            </div>
            ...
            <div className="mt-12 lg:mt-16 bg-white p-6 rounded-2xl shadow-xl max-w-2xl mx-auto lg:mx-0">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-y-6 gap-x-4 text-center">
                <div>
                  <p className="text-2xl sm:text-3xl font-bold text-gray-900">20+</p>
                  <p className="text-xs sm:text-sm text-gray-500 mt-1">Components</p>
                </div>
                <div>
                  <p className="text-2xl sm:text-3xl font-bold text-gray-900">10+</p>
                  <p className="text-xs sm:text-sm text-gray-500 mt-1">Pages</p>
                </div>
                <div>
          ...
          <div className="lg:col-span-5 xl:col-span-6 mt-12 lg:mt-0 flex items-center justify-center lg:justify-end">
            <div className="w-full max-w-sm sm:max-w-md lg:max-w-none flex items-center justify-center">
              <Image
                src="/hero.jpg"
                alt="Frameblox Robot"
                width={384}
              ...
              />
              {/* Placeholder
              <div className="w-full h-[400px] sm:h-[500px] md:h-[600px] bg-gray-300 rounded-lg flex items-center justify-center text-gray-500 shadow-2xl">
                <p className="text-2xl">Robot Image</p>
              </div>
              */}
            </div>
          </div>
